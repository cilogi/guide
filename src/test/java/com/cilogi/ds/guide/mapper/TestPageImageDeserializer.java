...
//
// File:        TestPageImageDeserializer.java  (08/11/15)
// Author:      tim
//
...
public class TestPageImageDeserializer {
    @SuppressWarnings("unused")
    static final Logger LOG = LoggerFactory.getLogger(TestPageImageDeserializer.class);


    public TestPageImageDeserializer() {
    }
